...
class user_signin(QWidget):
    ...
    def check(self):
        try:
            User(self.store, self.lineEdit_name.text(), self.lineEdit_lastname.text(),self.lineEdit_password.text(), self.lineEdit_phonenumber.text(), self.lineEdit_city.text())
