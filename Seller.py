...
class Seller:
    ...
    def __save(self):
        with open(f"./DATABASE/{self.__store}/Sellers/{self.__seller_id}.dat","wb") as dat_file: 
    ...
    def add_product_stock(self,product,price,stock):
        with open(f"./DATABASE/{self.__store}/Products/{product}.dat","rb") as product_file:
